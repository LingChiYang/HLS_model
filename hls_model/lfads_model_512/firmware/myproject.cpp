...
void myproject(
    ...
    #pragma HLS INTERFACE ap_vld port=input_1,input_2,layer16_out 
    #pragma HLS DATAFLOW 
    ...
    nnet::dense<layer3_t, layer4_t, config4>(layer3_out, layer4_out, w4, b4); // dense_mean

    layer6_t layer6_out[N_LAYER_6];
    #pragma HLS ARRAY_PARTITION variable=layer6_out complete dim=0
    nnet::dense<layer3_t, layer6_t, config6>(layer3_out, layer6_out, w6, b6); // dense_latent2

    layer8_t layer8_out[N_LAYER_4];
