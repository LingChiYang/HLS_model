...
struct config2_1 : nnet::dense_config {
    ...
    static const unsigned n_zeros = 4775;
    static const unsigned n_nonzeros = 70489;
...
struct config2_2 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::resource;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 95772;
    static const unsigned n_nonzeros = 690660;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef accum_dense2_t accum_t;
    typedef forward_bias2_t bias_t;
...
struct config4 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::resource;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 33980;
    static const unsigned n_nonzeros = 490308;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config6 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::resource;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 33997;
    static const unsigned n_nonzeros = 490291;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef model_default_t accum_t;
...
struct config12_1 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::resource;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 56841;
    static const unsigned n_nonzeros = 729591;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config12_2 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::resource;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 95745;
    static const unsigned n_nonzeros = 690687;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef accum_dense12_t accum_t;
    typedef bias12_t bias_t;
...
struct config17 : nnet::conv1d_config {
    ...
    using fill_buffer = nnet::fill_buffer_17<data_T, CONFIG_T>;
    typedef model_default_t accum_t;
    typedef bias17_t bias_t;
    typedef nerual_dense_weight_t weight_t;
