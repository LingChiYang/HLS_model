...
struct config2_1 : nnet::dense_config {
    ...
    static const unsigned n_zeros = 4732;
    static const unsigned n_nonzeros = 70532;
...
struct config2_2 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::resource;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 95547;
    static const unsigned n_nonzeros = 690885;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef accum_dense2_t accum_t;
    typedef forward_bias2_t bias_t;
...
struct config4 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::resource;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 33819;
    static const unsigned n_nonzeros = 490469;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config6 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::resource;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 34186;
    static const unsigned n_nonzeros = 490102;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef model_default_t accum_t;
...
struct config12_1 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::resource;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 56832;
    static const unsigned n_nonzeros = 729600;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
...
struct config12_2 : nnet::dense_config {
    ...
    static const unsigned strategy = nnet::resource;
    static const unsigned reuse_factor = 1;
    static const unsigned n_zeros = 95381;
    static const unsigned n_nonzeros = 691051;
    static const unsigned multiplier_limit = DIV_ROUNDUP(n_in * n_out, reuse_factor) - n_zeros / reuse_factor;
    static const bool store_weights_in_bram = false;
    typedef accum_dense12_t accum_t;
    typedef bias12_t bias_t;
